<template>
  ...
  <div class="arrow">
    ...
    <div>
      <a href="/radio" type="button" class="btn btn-outline-success"><i class="fa-solid fa-arrow-left"></i> Previous</a>
    </div>
    <div>
      <a href="/marche" type="button" class="btn btn-outline-success">Next <i class="fa-solid fa-arrow-right"></i></a>
    </div>
