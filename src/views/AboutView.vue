<template>
  ...
  <div class="about">
    <div class="title">
      <h1 style="color:green">ACCOMMODATION</h1>
      <p>Au cours de votre séjour à Kara, osez sortir et profiter de tous les instants.
    ...
    <div class="acc">
      <div class="row" id="items">
        ...
        <div class="col-lg-3">
          ...
          <div class="box2">
            <a href="/gym">
              <h2 style="color:green">Les Centres de Bien etre</h2>
            </a>
          </div>
        </div>
